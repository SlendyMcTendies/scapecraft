...
public class MultipartEntityBase extends Entity {

    private static final EntityDataAccessor<Optional<UUID>> PARENT_UUID = SynchedEntityData.defineId(MultipartEntityBase.class, EntityDataSerializers.OPTIONAL_UUID);
    private static final EntityDataAccessor<Float> SCALE_WIDTH = SynchedEntityData.defineId(MultipartEntityBase.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> SCALE_HEIGHT = SynchedEntityData.defineId(MultipartEntityBase.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> PART_YAW = SynchedEntityData.defineId(MultipartEntityBase.class, EntityDataSerializers.FLOAT);
    ...
    protected MultipartEntityBase(EntityType<?> t, Level world) {
        super(t, world);
    ...
    public MultipartEntityBase(EntityType<?> t, Entity parent, float radius, float angleYaw, float offsetY, float sizeX,
    ...
    public void collideWithNearbyEntities() {
        ...
        if (parent != null) {
            entities.stream().filter(entity -> entity != parent && !sharesRider(parent, entity) && !(entity instanceof MultipartEntityBase) && entity.isPushable()).forEach(entity -> entity.push(parent));
