...
public class ModSpawnEggItem extends SpawnEggItem {
    ...
    private static final Map<EntityType<?>, ModSpawnEggItem> TYPE_MAP = new IdentityHashMap<>();
    private final Supplier<? extends EntityType<?>> typeSupplier;

    public ModSpawnEggItem(Supplier<? extends EntityType<?>> type, int backgroundColor, int highlightColor, Properties props)
    {
