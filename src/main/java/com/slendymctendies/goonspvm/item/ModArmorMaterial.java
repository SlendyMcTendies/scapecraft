...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    INFERNAL_NETHERITE("infernal_netherite", 40, new int[]{3, 6, 8, 3},12, SoundEvents.ARMOR_EQUIP_NETHERITE,
            4f, 0.15f, () -> {return Ingredient.of(ModItems.INFERNALNETHERITEINGOT.get());
    }),

    GLACIAL_NETHERITE("glacial_netherite", 40, new int[]{3, 6, 8, 3},12, SoundEvents.ARMOR_EQUIP_NETHERITE,
            4f, 0.15f, () -> {return Ingredient.of(ModItems.GLACIALNETHERITEINGOT.get());
    });
